...
info "Installing PHP versions 7.3, 7.4, 8.0, 8.1 and 8.2, including all useful extensions"
sleep 2

apt install php7.3 php7.3-fpm php7.3-cli php7.3-imagick php7.3-intl php7.3-redis php7.3-yaml php7.3-zip php7.3-gnupg -y
apt install php7.3-imap php7.3-mysql php7.3-gd php7.3-mbstring php7.3-curl php7.3-xml php7.3-bcmath php7.3-xdebug php7.3-pgsql -y
...
apt install php7.4-imap php7.4-mysql php7.4-gd php7.4-mbstring php7.4-curl php7.4-xml php7.4-bcmath php7.4-xdebug php7.4-pgsql -y
...
apt install php8.0-imap php8.0-mysql php8.0-gd php8.0-mbstring php8.0-curl php8.0-xml php8.0-bcmath php8.0-xdebug php8.0-pgsql -y
...
apt install php8.1-imap php8.1-mysql php8.1-gd php8.1-mbstring php8.1-curl php8.1-xml php8.1-bcmath php8.1-xdebug php8.1-pgsql -y
...
apt install php8.2-imap php8.2-mysql php8.2-gd php8.2-mbstring php8.2-curl php8.2-xml php8.2-bcmath php8.2-xdebug php8.2-pgsql -y
