...
apt install gnupg git build-essential openjdk-17-jdk python3-dev python3-pip python3-venv -y
...
apt install php php-fpm php-cli php-http php-imagick php-intl php-redis php-yaml php-zip -y
